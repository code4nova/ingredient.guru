 ...
 SELECT                                                                                                                                     
         food_desc.shrt_desc as short_description                                                                                          
         nutrient_LUTZEA.nutr_val as amount                                                                                                
 FROM                                                                                                                                       
         import.food_description food_desc                                                                                                  
 left JOIN nutrient.LUTZEA nutrient_LUTZEA ON to_number(nutrient_LUTZEA.ndb_no '99999') = to_number(food_desc.ndb_no '99999')
